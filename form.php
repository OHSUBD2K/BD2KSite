...
<form id="oer_usage">
        <p>It looks like you are going to use this material. Please consider sharing some information with us. This is voluntary and does not effect your ability to use this educational material. However, it does help us see who has been using or examining our materials.</p>
        <p>Your information will be kept secure and confidential.</p> 
        <p>If you have any questions, please contact us at <a href="mailto:BD2K@ohsu.edu">BD2K@ohsu.edu</a>.</p>
    ...
    <fieldset id="userInfo">
        ...
        <input id="userEmail" name="userEmail" type="text" value="" placeholder="sample@sample.com"/></li>
